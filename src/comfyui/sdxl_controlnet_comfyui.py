...
# 图生图工作流文件
WORKERFLOW = "sdxl_controlnet.json"
COMFYUI_ENDPOINT = '127.0.0.1:8188'
OUTPUT_FOLDER =  r"C:\Users\pc\Desktop\kute2025\sdxl"

client_id = str(uuid.uuid4())


def generate_image(input_image_name: str):
    try:
        # 调用工作流
        generate_file = comfy_ui_contronet(input_image_name)
...
def comfy_ui_contronet(input_image_name):
    # 连接到comfyui
    ...
    prompt_data = parse_workflow(WORKERFLOW, input_image_name)
    # 将请求发往comfyui
...
def parse_workflow(workflowfile, local_file_name):
